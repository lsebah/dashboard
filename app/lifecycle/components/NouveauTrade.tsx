    ...
    <div className="fixed inset-0 z-50 overflow-auto bg-slate-900/40 p-4">
      <div className="mx-auto max-w-3xl rounded-lg bg-white shadow-xl">
        ...
        <div className="space-y-5 p-5">
          ...
          <div>
            <div className="mb-1 flex items-center justify-between">
              ...
              <button onClick={() => copy('email', emailText)} className="rounded-md bg-cmf-blue px-2.5 py-0.5 text-xs font-medium text-white hover:bg-blue-700">
        ...
        <div className="flex justify-end gap-2 rounded-b-lg border-t border-slate-200 px-5 py-3">
          <button onClick={onClose} className="rounded-md border border-slate-300 bg-white px-4 py-1.5 text-sm text-slate-600 hover:bg-slate-50">
            Fermer
          </button>
        </div>
      </div>
